...
Future<void> _initProductsAdmin() async {
  sl
    ...
    ..registerLazySingleton(() => ProductsAdminDataSource(sl(), DioFactory.getDio()))
    ..registerFactory(() => GetAllAdminProductBloc(sl()))
    ..registerFactory(() => CreateProdcutBloc(sl(), sl()))
...
Future<void> _initAdminOrders() async {
  sl
    ..registerFactory(() => AdminOrdersCubit(sl()))
    ..registerFactory(() => UpdateOrderStatusCubit(sl()))
    ..registerLazySingleton(() => AdminOrdersRepo(sl()))
    ..registerLazySingleton(AdminOrdersDataSource.new);
}
...
Future<void> _initOrders() async {
  sl
    ..registerFactory(() => MyOrdersCubit(sl()))
    ..registerFactory(() => OrderTrackingCubit(sl()))
    ..registerLazySingleton(() => OrdersRepo(sl()))
    ..registerLazySingleton(OrdersRemoteDataSource.new);
}
