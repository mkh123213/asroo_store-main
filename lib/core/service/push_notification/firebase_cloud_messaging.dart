    ...
    try {
      final response = await Dio().post<dynamic>(
        ...
        data: {
          ...
          'data': {'productId': -1, 'orderId': orderId},
        },
      );

      debugPrint('Device Notification Created => ${response.data}');
    } catch (e) {
      debugPrint('Device Notification Error => $e');
    }
  }
}
